            ...
            {news.map((val, i) => (
              <SplideSlide className="mb-0.5" key={i}>
                <div className="relative grid items-center gap-4 pb-2 rounded-lg shadow shadow-slate-200 ring-1 ring-slate-200">
                  ...
                  <div className="flex item-center justify-between w-full px-4">
                    <div className="flex item-center gap-0.5 ">
                      <HeartIcon className="icon-style text-red-500 w-5 h-5" />
                      <span className="text-sm font-bold">{val.like}</span>
                    </div>
                    <div className="flex item-center gap-0.5">
                  ...
                  <div className="grid item-center justify-item-start px-4 ">
                  ...
                  <div className="flex items-center justify-center px-4 w-full ">
                    <a
                      href={val.url}
                      className="w-full bg-gradient-to-b from-slate-900 to-black shadow-md shadow-black button-theme text-center text-slate-100 py-1.5 "
                      target={"_blank"}
                      role={"button"}
                    >
                      {val.btn}
