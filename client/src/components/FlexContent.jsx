  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex items-center justify-center max-w-xl realative lg:max-w-none w-full">
          <img
            src={img}
            alt={`img/${heading}}`}
            className={`w-auto object-fill transitions-theme first-letter ${
              ifExists
                ? "h-60 lg:h-56 md:h-52 sm:h-44 xsm:h-36 rotate-6 hover:-rotate-12"
                : "h-70 lg:h-64 md:h-60 sm:h-48 xsm:h-40 rotate-[19deg] hover:rotate-12"
            }`}
          />
        </div>
      </div>
